...
FROM
    (
        SELECT
            ...
            NULL::Nullable(Integer) AS munc_number,
            NULL::Nullable(Integer) AS munc_zip_code,
            area_id,
            zone_id,
            land_number,
            land_sub_number,
            ...
            master_project_id,
            project_id,
            NULL::Nullable(Integer) AS separated_from,
            NULL::Nullable(Integer) AS separated_reference,
            property_id,
