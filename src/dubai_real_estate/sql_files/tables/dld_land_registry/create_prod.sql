...
"{dld_database}"."{dld_table}"(
        ...
        "parcel_number" Nullable(Int128) COMMENT '[PK] Unique land parcel identifier - joins to buildings and units',
        ...
        "land_property_number" Nullable(Int128) COMMENT '[REF] Land property registration number',
        "land_separated_from" Nullable(Int128) COMMENT '[REF] Original parcel number if land was subdivided from larger plot',
        "land_separated_reference" Nullable(Int128) COMMENT '[REF] Reference number for land subdivision process',
        ...
        "project_id" Nullable(Int128) COMMENT '[FK] Specific project if land is part of development',
