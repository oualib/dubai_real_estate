...
SELECT
	FORMAT_INT("contract_id") AS "contract_id",
	FORMAT_CONTRACT_TYPE("contract_type") AS "contract_type",
	...
	MAP_EJARI_BUS_PROPERTY_TYPE(FORMAT_INT("ejari_bus_property_type_id_varchar")) AS "property_type_id",
	...
	FORMAT_DATE("contract_start_date") AS "contract_start_date",
	FORMAT_DATE("contract_end_date") AS "contract_end_date",
