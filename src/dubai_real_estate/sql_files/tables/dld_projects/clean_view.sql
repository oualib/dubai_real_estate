...
SELECT
    area_id,
    NULL::Nullable(Integer) AS zoning_authority_id,
    NULL::Nullable(Integer) AS master_developer_number,
    NULL::Nullable(Integer) AS developer_number,
    NULL::Nullable(Integer) AS escrow_agent_id,
    NULL::Nullable(Integer) AS property_id,
    master_project_id,
    master_project_en, 
    master_project_ar,
    project_id,
    ...
    project_name_en,
    project_name_ar,
    NULL::Nullable(Integer) AS project_type_id,
    NULL::Nullable(Integer) AS project_classification_id,
    NULL::Nullable(Integer) AS project_status_id,
    project_start_date,
    NULL::Nullable(Date) AS project_end_date,
    NULL::Nullable(Date) AS completion_date,
    NULL::Nullable(Date) AS cancellation_date,
    NULL::Nullable(Integer) AS percent_completed,
    ...
    (
        ...
        (
            SELECT 
                ...
                COALESCE(p0.zoning_authority_id, p1.zoning_authority_id) AS zoning_authority_id,
                COALESCE(p0.master_developer_number, p1.master_developer_number) AS master_developer_number,
                COALESCE(p0.developer_number, p1.developer_number) AS developer_number,
                COALESCE(p0.escrow_agent_id, p1.escrow_agent_id) AS escrow_agent_id,
                ...
                COALESCE(p0.project_number, p1.project_number) AS project_number,
                ...
                COALESCE(p0.project_type_id, p1.project_type_id) AS project_type_id,
                COALESCE(p0.project_classification_id, p1.project_classification_id) AS project_classification_id,
                COALESCE(p0.project_status_id, p1.project_status_id) AS project_status_id,
                ...
                COALESCE(p0.percent_completed, p1.percent_completed) AS percent_completed,
                COALESCE(p0.no_of_lands, p1.no_of_lands) AS no_of_lands,
                COALESCE(p0.no_of_buildings, p1.no_of_buildings) AS no_of_buildings,
                COALESCE(p0.no_of_villas, p1.no_of_villas) AS no_of_villas,
                COALESCE(p0.no_of_units, p1.no_of_units) AS no_of_units,
...
(
    SELECT
        ...
        NULL::Nullable(Integer) AS no_of_buildings,
        NULL::Nullable(Integer) AS no_of_villas,
        NULL::Nullable(Integer) AS no_of_units,
        NULL::Nullable(Varchar) AS project_description_en,
        NULL::Nullable(Varchar) AS project_description_ar
    FROM (
        SELECT * FROM
...
(
    SELECT
        NULL::Nullable(Integer) AS area_id,
        NULL::Nullable(Integer) AS zoning_authority_id,
        NULL::Nullable(Integer) AS master_developer_number,
        NULL::Nullable(Integer) AS developer_number,
        NULL::Nullable(Integer) AS escrow_agent_id,
