...
SELECT
	...
	FORMAT_VARCHAR("master_developer_name_ar") AS "master_developer_name_ar",
	FORMAT_INT("developer_number") AS "developer_number",
	FORMAT_VARCHAR("developer_name_ar") AS "developer_name_ar",
	...
	FORMAT_VARCHAR("project_status_en") AS "project_status_en",
